    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Cadastrar Laboratorista<a  href="#" class='pull-right' data-toggle="tooltip" data-placement="bottom" title="O campo DDD se refere ao DDD do seu número de telefone. Para realizar o cadastro do cliente, basta preencher com os dados da laboratorista e apertar o botão Cadastrar laboratorista. "><i class="fa fa-question-circle fa-2x"></i></a></div>
                ...
                @endif
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/laboratorista') }}">
                        {{ csrf_field() }}
    ...
    <div class="col-lg-12">
      ...
      <table id="myTable" class="table table-responsive table-striped table-hover">
        ...
        <tbody>
          ...
          @if(!$admin->isEmpty())
            @foreach($admin as $key => $value)
              <tr>
                ...
                <td>
                  {!! Form::open(['method' => 'DELETE','route' => ['laboratorista.destroy', $value->admin_id],'style'=>'display:inline']) !!}
                  {!! Form::submit('Deletar', ['class' => 'btn btn-danger']) !!}
                  {!! Form::close() !!}
                  <a class="btn btn-primary" href="{{ route('laboratorista.edit',$value->admin_id) }}">Editar</a>
          ...
          @else
            <tr>
              <td colspan="3">Não há registros de laboratoristas</td>
            </tr>
          @endif
        </tbody>
      </table>
