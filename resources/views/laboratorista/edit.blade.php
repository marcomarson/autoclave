...
<div class="row">
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">Editar Cliente  <a  href="#" class='pull-right' data-toggle="tooltip" data-placement="bottom" title=" O campo DDD se refere ao DDD do seu número de telefone. Para atualizar o cadastro, é preciso preencher as lacunas a esquerda. "><i class="fa fa-question-circle fa-2x"></i></a></div>
            <div class="panel-body">
                {{ csrf_field() }}
                {!! Form::model($admin, ['method' => 'PATCH','route' => ['laboratorista.update', $admin->admin_id], 'class' => 'form-horizontal']) !!}
                {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="nome" type="text" class="form-control" name="nome" value="{{ $admin->nome }}">
                ...
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-btn fa-edit"></i> Atualizar laboratorista
                        </button>
                    </div>
                </div>
